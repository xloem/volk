...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    QA(VOLK_INIT_TEST(volk_32f_stddev_and_mean_32f_x2, test_params.make_tol(1e-4)))
    ...
    QA(VOLK_INIT_TEST(volk_8i_convert_32f, test_params))
    QA(VOLK_INIT_TEST(volk_8i_convert_64f, test_params))
    QA(VOLK_INIT_TEST(volk_8u_convert_32f, test_params))
    QA(VOLK_INIT_TEST(volk_8u_convert_64f, test_params))
